...
# Data: 30/04/2024
# Descrição: Este script assume uma role na AWS utilizando o AWS CLI sem o uso de External ID e configura um perfil temporário com as credenciais obtidas.
# É ideal para cenários internos onde o controle de acesso entre contas é menos restritivo.
